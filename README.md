# Underrelay / Нижний контур — V0.1.1
...
**[Скачать демо для Windows — EXE и ресурсы в ZIP](https://github.com/mospromsoft-dotcom/Underrelay-Demo/releases/download/v0.1.1/Underrelay-0.1.1-win64.zip)** · [Страница выпуска](https://github.com/mospromsoft-dotcom/Underrelay-Demo/releases/tag/v0.1.1) · [Изменения](CHANGELOG.md)
...
SDL3.dll, папки assets и shaders должны оставаться рядом с EXE. Интернет и установка дополнительных инструментов для игры не нужны. Автоматические архивы GitHub «Source code» содержат страницу демо; готовая игра находится в `Underrelay-0.1.1-win64.zip`.

Новое в V0.1.1: свободный оборот камеры вокруг сцены, наклон 25–65°, удержание наведения во время вращения. F2/F3 сохраняют выбранный угол.

![Двор с обратной стороны](images/orbit.png)
