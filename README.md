# Underrelay / Нижний контур — V0.2.1
...
**[Скачать демо для Windows — EXE и ресурсы в ZIP](https://github.com/mospromsoft-dotcom/Underrelay-Demo/releases/download/v0.2.1/Underrelay-0.2.1-win64.zip)** · [Страница выпуска](https://github.com/mospromsoft-dotcom/Underrelay-Demo/releases/tag/v0.2.1) · [Изменения](CHANGELOG.md)

![Исправленный контакт с землёй](images/shadows.png)

Новое в V0.2.1: исправлены смещение и размытие теней, большой зазор грунта редактора. Тени подходят к основаниям объектов. Модели, материалы, управление и пользовательские карты сохранены.
...
SDL3.dll, папки assets и shaders должны оставаться рядом с EXE. Интернет и установка дополнительных инструментов для игры не нужны. Автоматические архивы GitHub «Source code» содержат страницу демо; готовая игра находится в `Underrelay-0.2.1-win64.zip`.
